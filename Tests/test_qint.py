...
@patch("chimera_intel.core.qint.feedparser.parse", side_effect=Exception("ArXiv is down"))
...
def test_analyze_trl_heuristics(mock_get, qint_instance):
    ...
    # Test TRL 6 (qkd)
    mock_response.content = "<html><body>we focus on qkd and quantum sensing</body></html>"
    mock_get.return_value = mock_response
...
@patch("chimera_intel.core.qint.requests.get", side_effect=requests.RequestException("Network error"))
...
@patch("chimera_intel.core.qint.requests.get", side_effect=requests.RequestException("NIST is down"))
...
def test_cli_research_success(mock_scrape):
    ...
    mock_scrape.return_value = [
        {"title": "Paper 1", "authors": "Author A", "published": "2023-01-01T00:00:00Z", "link": "link1"},
        {"title": "Paper 2", "authors": "Author B", "published": "2023-01-02T00:00:00Z", "link": "link2"},
    ]
