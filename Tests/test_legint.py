...
from chimera_intel.core.legint import search_court_dockets
from chimera_intel.core.schemas import DocketSearchResult, ProjectConfig
...
class TestLegint(unittest.TestCase):
    ...
    def test_cli_docket_search_with_project(
        ...
        result = runner.invoke(app, ["legint", "docket-search"])
