...
from chimera_intel.core.schemas import StaticAppAnalysisResult, FoundSecret
...
class TestAppint(unittest.TestCase):
    ...
    def test_analyze_apk_static_success(self, mock_exists, mock_subprocess, mock_rmtree):
