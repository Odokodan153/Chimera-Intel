...
from chimera_intel.core.cognitive_warfare_engine import cognitive_warfare_app, CognitiveWarfareEngine
...
MOCK_NARRATIVE_DATA = [
    ...
    {'content': 'The corrupt elites are causing this problem.', 'sentiment': 'negative'}
]
...
def mock_data_sources():
    ...
    with patch('chimera_intel.core.cognitive_warfare_engine.track_narrative') as mock_narrative, \
         patch('chimera_intel.core.cognitive_warfare_engine.monitor_twitter_stream') as mock_social:
        
        mock_narrative.return_value = MOCK_NARRATIVE_DATA
...
def test_cli_command(mock_data_sources):
    ...
    result = runner.invoke(
        ...
        [
            "deploy-shield",
            "--narrative", "economic stability",
            "--keywords", "risk,threat"
        ],
    )
