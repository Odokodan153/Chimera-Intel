...
@pytest.mark.parametrize("message, expected_violation, triggered_by", [
    ...
    ("You really don't want to let us down, do you?", "emotional_manipulation", "let us down"),
    ("Don't be difficult, just sign.", "emotional_manipulation", "don't be difficult"),

    # Test information_hiding
    ("That's not important right now.", "information_hiding", "that's not important"),
...
def test_check_message_various_cases(default_guardrails, message, expected_violation, triggered_by):
...
def test_check_message_multiple_violations(default_guardrails):
    ...
    message = "This is your last chance, and to be honest, you'll let us down if you refuse."
    violations = default_guardrails.check_message(message)
