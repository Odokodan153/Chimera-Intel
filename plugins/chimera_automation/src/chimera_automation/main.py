...
class AutomationPlugin(ChimeraPlugin):
    ...
    def app(self) -> typer.Typer:
        ...
        plugin_app.add_typer(automation_app, name="auto", help="Run automation, enrichment, and advanced analysis tasks.")
        plugin_app.add_typer(connect_app, name="connect", help="Integrate and orchestrate with external security tools.")
        return plugin_app
