...
class AnalysisPlugin(ChimeraPlugin):
    ...
    def app(self) -> typer.Typer:
        ...
        analysis_group_app = typer.Typer(
            help="Run AI-powered and historical analysis."
        )
        ...
        analysis_group_app.add_typer(
            pestel_analyzer_app, name="pestel", help="Generates an AI-powered PESTEL analysis."
        )
        analysis_group_app.add_typer(
            competitive_analyzer_app, name="competitive", help="Generates an AI-powered comparison of two targets."
        )
        analysis_group_app.add_typer(
            lead_suggester_app, name="suggest-leads", help="AI suggests next steps for the active project."
        )
        analysis_group_app.add_typer(
