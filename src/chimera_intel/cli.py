...
# Ensure the database is created and ready before any command is run.
initialize_database()
...
analysis_app.add_typer(social_app, name="social", help="Analyzes content from a target's RSS feed.")
...
if __name__ == "__main__":
    # This block allows the script to be run directly (e.g., 'python -m chimera_intel.cli')
    # during development. The 'project.scripts' in pyproject.toml is what enables
    # the 'chimera' command after installation.
    app()