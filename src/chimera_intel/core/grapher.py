...
def generate_knowledge_graph(json_data: Dict[str, Any], output_path: str) -> None:
    ...
    try:
        ...
        logger.info("Successfully generated interactive graph at: %s", os.path.abspath(output_path))
...
def create_knowledge_graph(
    ...
    output_file: str = typer.Option(None, "--output", "-o", help="Path to save the HTML graph.")
):
