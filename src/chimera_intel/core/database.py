...
def initialize_database() -> None:
    ...
    # --- CHANGE: Add a fallback for any other unexpected errors ---
        ...
        console.print(f"[bold red]An unexpected error occurred during database initialization:[/] {e}")
...
def save_scan_to_db(target: str, module: str, data: Dict[str, Any]) -> None:
    ...
    # --- CHANGE: Add a fallback for any other unexpected errors ---
        ...
        console.print(f"[bold red]An unexpected error occurred while saving to the database:[/] {e}")
...
def get_aggregated_data_for_target(target: str) -> Optional[Dict[str, Any]]:
    ...
    # --- CHANGE: Add a fallback for any other unexpected errors ---
        ...
        console.print(f"[bold red]An unexpected error occurred while fetching aggregated data:[/] {e}")
        return None